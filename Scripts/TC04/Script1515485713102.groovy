...
//Mobile.verifyMatch('Hello world!', 'Hello world!', false)
Mobile.verifyElementAttributeValue(findTestObject('android.widget.TextView1 - Hello world'), 'text', 'Hello world1', 3)
